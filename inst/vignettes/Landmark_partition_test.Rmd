...
## The "back of the skull" partition
land_back <- seq(1:12)[-land_fron]

## Listing them for later
partitions <- list("front" = land_fron, "back" = land_back)
```
...
species_means_difference <- coordinates.difference(species_means[[1]], species_means[[1]],
                                                   type = "spherical")
```
...
```{r}
## Calculating the range of variation



## The random permutation test for the area difference
rand.test(data[, "radius"], partition, test = area.diff, test.parameter = cTRUE)
